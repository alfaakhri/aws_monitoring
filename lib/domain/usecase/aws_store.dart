  ...
  void createSandi(
    ...
    if (kecAngin.contains(".")) {
      ...
      if (newKecAngin.toString().length == 1) {
        newKecAngin = int.parse(StringUtils.addCharAtPosition(newKecAngin.toString(), "0", 0));
      } 
    ...
    _sandi20 = "57" + jenisAwanKonvektif.split("-")[0] + arahAwanKonvektif.split("-")[0] + sudutAwanKonvektif.split("-")[0];
    ...
    _sandi24 = "8" + banyakOktaNS2.split("-")[0] + jenisC2.split("-")[0] + newTinggiHshs2.toString().split(".")[0];
    _sandi25 = "8" + banyakOktaNS3.split("-")[0] + jenisC3.split("-")[0] + newTinggiHshs3.toString().split(".")[0];

    print("1. $sandiPengenal 2. $_sandi2 3. $nomorStasiun 4. $_sandi4 5. $_sandi5 6. $_sandi6 7. $_sandi7 8. $_sandi8 9. $_sandi9 10. $_sandi10 11. $_sandi11 12. $_sandi12 13. $_sandi13 14. $_sandi14 15. $_sandi15 16. $_sandi16 17. $_sandi17 18. $_sandi18 19. $_sandi19 20. $_sandi20 21. $_sandi21 22. $_sandi22 23. $_sandi23 24. $_sandi24 25. $_sandi25");
    _hasilSandi48 = sandiPengenal + " " + _sandi2 + " " + nomorStasiun + " " + _sandi4 + " " + _sandi5 + " " + _sandi6 + " " + _sandi7 + " " + _sandi8 + " " + _sandi9 + " " + _sandi10 + " " + _sandi11 + " " + _sandi12 + " " + _sandi13 + " " + _sandi14 + " " + _sandi15 + " " +  _sandi16 + " " + _sandi17 + " " + _sandi18 + " " + _sandi19 + " " + _sandi20 + " " + _sandi21 + " " + _sandi22 + " " + _sandi23 + " " + _sandi24 + " " + _sandi25;

    print("1. $newStasiun 2. $newTanggal45 3. $newTime45 4. $newTitikEmbun 5. ${bagianLangit.split('-')[0]} 6. $newArahAngin 7. $newKecAngin 8. $penglihatanMendatar 9. ${keadaanCuacaWaktuPengamatan.split("-")[0]} 10. ${keadaanCuacaLalu1.split("-")[0]} 11. ${keadaanCuacaLalu2.split("-")[0]} 12. $newQFF 13. $newBolaKering 14. ${banyakOktaNH.split("-")[0]} 15. ${awanRendahJenis.split("-")[0]} 16. ${tinggiDasarCL1.split("-")[0]} 17. ${awanMenengahJenis.split("-")[0]} 18. ${awanTinggiJenis.split("-")[0]} 19. ${banyakOktaNS1.split("-")[0]} 20. ${jenisC1.split("-")[0]} 21. ${newTinggiHshs1.toString().split(".")[0]} 22. ${banyakOktaNS2.split("-")[0]} 23. ${jenisC2.split("-")[0]} 24. ${newTinggiHshs2.toString().split(".")[0]} 25. 0 26. ${jenisC3.split("-")[0]} 27. ${newTinggiHshs3.toString().split(".")[0]} 28. ${jenisAwanKonvektif.split("-")[0]} 29. ${arahAwanKonvektif.split("-")[0]} 30. ${sudutAwanKonvektif.split("-")[0]} 31. ${lembabNisbi.split(".")[0]} 32. $newQFE 33. $newBolaBasah 34. $newHujan6jamlalu 35. 1 36. ${suhuMax.replaceAll(".", "")} 37. ${suhuMin.replaceAll(".", "")} 38. $newJumlahPenguapan24jam 39. $newRadiasi 40. $newPenyinaranMatahari 41. ${arahCL1.split("-")[0]} 42. ${arahAwanMenengah.split("-")[0]} 43. ${arahAwanTinggi.split("-")[0]} 44. $newSelisihQFF 45. ${pengenalDataAngin.split("-")[0]} 46. ${pengenalDataCuaca.split("-")[0]} 47. ${pengenalDataHujan.split("-")[0]} 48. ${dataAlatPenguapan.split("-")[0]}");
    _hasilSandi45 = newStasiun + newTanggal45 + "\n" + newTime45 + newTitikEmbun + bagianLangit.split('-')[0] + newArahAngin + newKecAngin.toString() + penglihatanMendatar + keadaanCuacaWaktuPengamatan.split("-")[0] + keadaanCuacaLalu1.split("-")[0] + keadaanCuacaLalu2.split("-")[0] + newQFF + newBolaKering + banyakOktaNH.split("-")[0] + awanRendahJenis.split("-")[0] + tinggiDasarCL1.split("-")[0] + awanMenengahJenis.split("-")[0] + awanTinggiJenis.split("-")[0] + banyakOktaNS1.split("-")[0] + jenisC1.split("-")[0] + newTinggiHshs1.toString().split(".")[0] + banyakOktaNS2.split("-")[0] + jenisC2.split("-")[0] + newTinggiHshs2.toString().split(".")[0] + "0" + jenisC3.split("-")[0] + newTinggiHshs3.toString().split(".")[0] + jenisAwanKonvektif.split("-")[0] + arahAwanKonvektif.split("-")[0] + sudutAwanKonvektif.split("-")[0] + lembabNisbi.split(".")[0] + newQFE + newBolaBasah + newHujan6jamlalu + "1" + suhuMax.replaceAll(".", "") + suhuMin.replaceAll(".", "") + newJumlahPenguapan24jam + newRadiasi + newPenyinaranMatahari + arahCL1.split("-")[0] + arahAwanMenengah.split("-")[0] + arahAwanTinggi.split("-")[0] + newSelisihQFF + pengenalDataAngin.split("-")[0] + pengenalDataCuaca.split("-")[0] + pengenalDataHujan.split("-")[0] + dataAlatPenguapan.split("-")[0];
